...
var v = (r, i, _) => (i in r ? L(r, i, { enumerable: !0, configurable: !0, writable: !0, value: _ }) : (r[i] = _)),
  u = (r, i) => {
    for (var _ in i || (i = {})) K.call(i, _) && v(r, _, i[_])
    if (E) for (var _ of E(i)) N.call(i, _) && v(r, _, i[_])
    return r
  },
  m = (r, i) => Z(r, M(i))
      ...
      var D = Object.defineProperty,
        ...
        b = (t, n, a, e) => {
          if ((n && typeof n == 'object') || typeof n == 'function')
            for (let o of T(n))
              !w.call(t, o) && o !== a && D(t, o, { get: () => n[o], enumerable: !(e = C(n, o)) || e.enumerable })
          return t
        },
        h = (t, n, a) => (b(t, n, 'default'), a && b(a, n, 'default')),
        d = {}
      h(d, B)
      var k = [
          'assign',
        ...
        s = { close: '>', id: 'angle', open: '<' },
        l = { close: '\\]', id: 'bracket', open: '\\[' },
        S = { close: '[>\\]]', id: 'auto', open: '[<\\[]' },
        f = { close: '\\}', id: 'dollar', open1: '\\$', open2: '\\{' },
        F = { close: '\\]', id: 'bracket', open1: '\\[', open2: '=' }
      function g(t) {
        return {
          brackets: [
            ['<', '>'],
...
\r	 }]),.:;=`,
          ...
          folding: {
            markers: {
              start: new RegExp(`${t.open}#(?:${p.join('|')})([^/${t.close}]*(?!/)${t.close})[^${t.open}]*$`),
              end: new RegExp(`${t.open}/#(?:${p.join('|')})[\\r\\n\\t ]*>`),
            },
          },
          onEnterRules: [
            {
              beforeText: new RegExp(
                `${t.open}#(?!(?:${k.join('|')}))([a-zA-Z_]+)([^/${t.close}]*(?!/)${t.close})[^${t.open}]*$`,
              ),
...
\r	 }]),.:;=`,
          ...
          folding: {
            markers: {
              start: new RegExp(`[<\\[]#(?:${p.join('|')})([^/>\\]]*(?!/)[>\\]])[^<\\[]*$`),
              end: new RegExp(`[<\\[]/#(?:${p.join('|')})[\\r\\n\\t ]*>`),
            },
          },
          onEnterRules: [
            {
              beforeText: new RegExp(`[<\\[]#(?!(?:${k.join('|')}))([a-zA-Z_]+)([^/>\\]]*(?!/)[>\\]])[^[<\\[]]*$`),
      ...
      function c(t, n) {
        const a = `_${t.id}_${n.id}`,
          e = (A) => A.replace(/__id__/g, a),
          o = (A) => {
            const z = A.source.replace(/__id__/g, a)
            return new RegExp(z, A.flags)
          }
        return {
          unicode: !0,
          includeLF: !1,
      ...
      function $(t) {
        ...
        return m(u(u(u({}, n), a), e), {
          ...
          tokenizer: u(u(u({}, n.tokenizer), a.tokenizer), e.tokenizer),
        })
      }
      var P = { conf: g(s), language: c(s, f) },
        I = { conf: g(l), language: c(l, f) },
        y = { conf: g(s), language: c(s, F) },
        O = { conf: g(l), language: c(l, F) },
        R = { conf: x(), language: $(f) },
        j = { conf: x(), language: $(F) }
    },
  },
