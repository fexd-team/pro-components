...
var Gt = (N, I, P) => (I in N ? $t(N, I, { enumerable: !0, configurable: !0, writable: !0, value: P }) : (N[I] = P))
var S = (N, I, P) => (Gt(N, typeof I != 'symbol' ? I + '' : I, P), P)
;(self.webpackChunk = self.webpackChunk || []).push([
  [823],
  {
    10823: function (N, I, P) {
      P.r(I),
        P.d(I, {
      ...
      var ut = Object.defineProperty,
        ...
        fe = (e, n, i, r) => {
          if ((n && typeof n == 'object') || typeof n == 'function')
            for (let t of dt(n))
              !ft.call(e, t) && t !== i && ut(e, t, { get: () => n[t], enumerable: !(r = ct(n, t)) || r.enumerable })
          return e
        },
        lt = (e, n, i) => (fe(e, n, 'default'), i && fe(i, n, 'default')),
        l = {}
      lt(l, ot)
      var gt = 2 * 60 * 1e3,
        le = class {
          constructor(e) {
            S(this, '_defaults')
            S(this, '_idleCheckInterval')
            S(this, '_lastUsedTime')
            S(this, '_configChangeListener')
            S(this, '_worker')
            S(this, '_client')
            ;(this._defaults = e),
              (this._worker = null),
          ...
          _checkIfIdle() {
            ...
            Date.now() - this._lastUsedTime > gt && this._stopWorker()
          }
          _getClient() {
            return (
      ...
      ;(function (e) {
        function n(r, t, a, s) {
          ...
          if (T.is(r) && T.is(t)) return { start: r, end: t }
      ...
      ;(function (e) {
        ...
        function i(r) {
          ...
          return (
            ...
            (_.is(t.targetSelectionRange) || o.undefined(t.targetSelectionRange)) &&
            (_.is(t.originSelectionRange) || o.undefined(t.originSelectionRange))
          )
        }
        e.is = i
      })(he || (he = {}))
      ...
      ;(function (e) {
        function n(r, t, a, s) {
          return { red: r, green: t, blue: a, alpha: s }
        }
        e.create = n
        function i(r) {
          var t = r
      ...
      ;(function (e) {
        ...
        function i(r) {
          var t = r
          return _.is(t.range) && ie.is(t.color)
        }
        e.is = i
      })(ve || (ve = {}))
      var pe
      ;(function (e) {
        ...
        function i(r) {
          ...
          return (
            o.string(t.label) &&
            (o.undefined(t.textEdit) || R.is(t)) &&
            (o.undefined(t.additionalTextEdits) || o.typedArray(t.additionalTextEdits, R.is))
          )
        }
        e.is = i
      })(pe || (pe = {}))
      ...
      ;(function (e) {
        function n(r, t, a, s, u) {
          var c = { startLine: r, endLine: t }
          return (
            o.defined(a) && (c.startCharacter = a),
            o.defined(s) && (c.endCharacter = s),
            o.defined(u) && (c.kind = u),
            c
          )
        }
        e.create = n
      ...
      ;(function (e) {
        ...
        function i(r) {
          var t = r
          return o.defined(t) && ne.is(t.location) && o.string(t.message)
        }
        e.is = i
      })(ae || (ae = {}))
      var O
      ...
      ;(function (e) {
        function n(r, t, a, s, u, c) {
          ...
          return (
            o.defined(a) && (d.severity = a),
            o.defined(s) && (d.code = s),
            o.defined(u) && (d.source = u),
            o.defined(c) && (d.relatedInformation = c),
            d
          )
        }
        e.create = n
        function i(r) {
          ...
          return (
            ...
            (o.undefined(a.codeDescription) ||
              o.string((t = a.codeDescription) === null || t === void 0 ? void 0 : t.href)) &&
            (o.string(a.source) || o.undefined(a.source)) &&
            (o.undefined(a.relatedInformation) || o.typedArray(a.relatedInformation, ae.is))
          )
        }
        e.is = i
      })(Q || (Q = {}))
      ...
      ;(function (e) {
        ...
        function t(a) {
          var s = a
          return R.is(s) && (j.is(s.annotationId) || k.is(s.annotationId))
        }
        e.is = t
      })(M || (M = {}))
      var Z
      ;(function (e) {
        ...
        function i(r) {
          var t = r
          return o.defined(t) && ee.is(t.textDocument) && Array.isArray(t.edits)
        }
        e.is = i
      })(Z || (Z = {}))
      var z
          ...
          return (
            ...
            (t.options === void 0 ||
              ((t.options.overwrite === void 0 || o.boolean(t.options.overwrite)) &&
                (t.options.ignoreIfExists === void 0 || o.boolean(t.options.ignoreIfExists)))) &&
            (t.annotationId === void 0 || k.is(t.annotationId))
          )
        }
        e.is = i
      })(z || (z = {}))
          ...
          return (
            ...
            (t.options === void 0 ||
              ((t.options.recursive === void 0 || o.boolean(t.options.recursive)) &&
                (t.options.ignoreIfNotExists === void 0 || o.boolean(t.options.ignoreIfNotExists)))) &&
            (t.annotationId === void 0 || k.is(t.annotationId))
          )
        }
        e.is = i
        ...
        function n(i) {
          ...
          return (
            ...
            (r.documentChanges === void 0 ||
              r.documentChanges.every(function (t) {
                return o.string(t.kind) ? z.is(t) || B.is(t) || X.is(t) : Z.is(t)
              }))
          )
        }
        e.is = n
      ...
      var K = (function () {
          ...
          return (
            ...
            (e.prototype.assertChangeAnnotations = function (n) {
              if (n === void 0) throw new Error('Text edit change is not configured to manage change annotations.')
            }),
            e
          )
        })(),
        we = (function () {
          function e(n) {
            ;(this._annotations = n === void 0 ? Object.create(null) : n), (this._counter = 0), (this._size = 0)
          }
          return (
            (e.prototype.all = function () {
            ...
            (e.prototype.manage = function (n, i) {
              var r
              if ((k.is(n) ? (r = n) : ((r = this.nextId()), (i = n)), this._annotations[r] !== void 0))
          ...
          return (
            ...
            (e.prototype.getTextEditChange = function (n) {
              if (ee.is(n)) {
                ...
                if (!r) {
                  var t = [],
                    a = { textDocument: i, edits: t }
                  this._workspaceEdit.documentChanges.push(a),
                    (r = new K(t, this._changeAnnotations)),
                ...
                if (!r) {
                  var t = []
                  ;(this._workspaceEdit.changes[n] = t), (r = new K(t)), (this._textEditChanges[n] = r)
                }
                return r
              }
            }),
            ...
            (e.prototype.createFile = function (n, i, r) {
              if ((this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0))
                throw new Error('Workspace edit is not configured for document changes.')
              var t
              j.is(i) || k.is(i) ? (t = i) : (r = i)
              var a, s
              if (
                (t === void 0
                  ? (a = z.create(n, r))
                  : ((s = k.is(t) ? t : this._changeAnnotations.manage(t)), (a = z.create(n, r, s))),
                this._workspaceEdit.documentChanges.push(a),
                s !== void 0)
              )
                return s
            ...
            (e.prototype.renameFile = function (n, i, r, t) {
              if ((this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0))
                throw new Error('Workspace edit is not configured for document changes.')
              var a
              j.is(r) || k.is(r) ? (a = r) : (t = r)
              var s, u
              if (
                (a === void 0
                  ? (s = B.create(n, i, t))
                  : ((u = k.is(a) ? a : this._changeAnnotations.manage(a)), (s = B.create(n, i, t, u))),
            ...
            (e.prototype.deleteFile = function (n, i, r) {
              ...
              if (
                (t === void 0
                  ? (a = X.create(n, r))
                  : ((s = k.is(t) ? t : this._changeAnnotations.manage(t)), (a = X.create(n, r, s))),
                this._workspaceEdit.documentChanges.push(a),
                s !== void 0)
              )
                return s
      ...
      ;(function (e) {
        function n(i) {
          ...
          return (
            !!r &&
            o.objectLiteral(r) &&
            (oe.is(r.contents) || te.is(r.contents) || o.typedArray(r.contents, te.is)) &&
            (i.range === void 0 || _.is(i.range))
          )
        }
        e.is = n
      })(De || (De = {}))
      ...
      ;(function (e) {
        function n(r, t, a, s, u, c) {
          var d = { name: r, detail: t, kind: a, range: s, selectionRange: u }
      ...
      ;(function (e) {
        ...
        function i(r) {
          var t = r
          return (
            o.defined(t) && o.typedArray(t.diagnostics, Q.is) && (t.only === void 0 || o.typedArray(t.only, o.string))
          )
        }
        e.is = i
      })(xe || (xe = {}))
      ...
      ;(function (e) {
        function n(r, t, a) {
          var s = { title: r },
            u = !0
          return (
            typeof t == 'string' ? ((u = !1), (s.kind = t)) : H.is(t) ? (s.command = t) : (s.edit = t),
            u && a !== void 0 && (s.kind = a),
            s
          )
        }
        ...
        function i(r) {
          ...
          return (
            t &&
            o.string(t.title) &&
            (t.diagnostics === void 0 || o.typedArray(t.diagnostics, Q.is)) &&
            (t.kind === void 0 || o.string(t.kind)) &&
            (t.edit !== void 0 || t.command !== void 0) &&
            (t.command === void 0 || H.is(t.command)) &&
            (t.isPreferred === void 0 || o.boolean(t.isPreferred)) &&
            (t.edit === void 0 || se.is(t.edit))
          )
        }
        e.is = i
      })(Fe || (Fe = {}))
      ...
      ;(function (e) {
        ...
        function i(r) {
          var t = r
          return o.defined(t) && _.is(t.range) && (o.undefined(t.command) || H.is(t.command))
        }
        e.is = i
      })(We || (We = {}))
      var Ue
      ...
      ;(function (e) {
        ...
        function i(a) {
          ...
          return !!(
            o.defined(s) &&
            o.string(s.uri) &&
            (o.undefined(s.languageId) || o.string(s.languageId)) &&
            o.uinteger(s.lineCount) &&
            o.func(s.getText) &&
            o.func(s.positionAt) &&
            o.func(s.offsetAt)
          )
        ...
        function r(a, s) {
          for (
            var u = a.getText(),
              c = t(s, function (D, U) {
                var $ = D.range.start.line - U.range.start.line
                return $ === 0 ? D.range.start.character - U.range.start.character : $
              }),
              d = u.length,
              v = c.length - 1;
            v >= 0;
            ...
            var g = c[v],
              C = a.offsetAt(g.range.start),
              h = a.offsetAt(g.range.end)
            if (h <= d) u = u.substring(0, C) + g.newText + u.substring(h, u.length)
        ...
        function t(a, s) {
          ...
          for (; v < c.length; ) a[C++] = c[v++]
          for (; g < d.length; ) a[C++] = d[g++]
          return a
        }
      })(ze || (ze = {}))
      var ht = (function () {
...
` &&
      ...
      ;(function (e) {
        ...
        e.number = s
        function u(h, D, U) {
          return n.call(h) === '[object Number]' && D <= h && h <= U
        }
        e.numberRange = u
        function c(h) {
        ...
        e.objectLiteral = g
        function C(h, D) {
          return Array.isArray(h) && h.every(D)
        }
        e.typedArray = C
      })(o || (o = {}))
      var Be = class {
        constructor(e, n, i) {
          S(this, '_disposables', [])
          S(this, '_listener', Object.create(null))
          ...
          const r = (a) => {
            ...
            t = (a) => {
              ...
              let s = a.uri.toString(),
                u = this._listener[s]
              u && (u.dispose(), delete this._listener[s])
            }
          this._disposables.push(l.editor.onDidCreateModel(r)),
            this._disposables.push(l.editor.onWillDisposeModel(t)),
            this._disposables.push(
              l.editor.onDidChangeModelLanguage((a) => {
                t(a.model), r(a.model)
              }),
            ),
            this._disposables.push(
      ...
      var Xe = class {
        ...
        provideCompletionItems(e, n, i, r) {
          ...
          return this._worker(t)
            .then((a) => a.doComplete(t.toString(), L(n)))
            .then((a) => {
              if (!a) return
              const s = e.getWordUntilPosition(n),
                u = new l.Range(n.lineNumber, s.startColumn, n.lineNumber, s.endColumn),
                c = a.items.map((d) => {
                  const v = {
                    label: d.label,
                  ...
                  return (
                    d.textEdit &&
                      (mt(d.textEdit)
                        ? (v.range = { insert: b(d.textEdit.insert), replace: b(d.textEdit.replace) })
                        : (v.range = b(d.textEdit.range)),
                      (v.insertText = d.textEdit.newText)),
                    d.additionalTextEdits && (v.additionalTextEdits = d.additionalTextEdits.map(x)),
                    d.insertTextFormat === ue.Snippet &&
                      (v.insertTextRules = l.languages.CompletionItemInsertTextRule.InsertAsSnippet),
                    v
                  )
                })
              return { isIncomplete: a.isIncomplete, suggestions: c }
            })
        }
      }
      function L(e) {
      ...
      function mt(e) {
        return typeof e.insert != 'undefined' && typeof e.replace != 'undefined'
      }
      function _t(e) {
      ...
      var qe = class {
        ...
        provideHover(e, n, i) {
          ...
          return this._worker(r)
            .then((t) => t.doHover(r.toString(), L(n)))
            .then((t) => {
              if (t) return { range: b(t.range), contents: Ct(t.contents) }
            })
        }
      }
      function wt(e) {
...
` +
      ...
      var bt = class {
        ...
        provideDocumentHighlights(e, n, i) {
          const r = e.uri
          return this._worker(r)
            .then((t) => t.findDocumentHighlights(r.toString(), L(n)))
            .then((t) => {
              if (t) return t.map((a) => ({ range: b(a.range), kind: Et(a.kind) }))
            })
        }
      }
      function Et(e) {
      ...
      var At = class {
        ...
        provideDefinition(e, n, i) {
          const r = e.uri
          return this._worker(r)
            .then((t) => t.findDefinition(r.toString(), L(n)))
            .then((t) => {
              if (t) return [Ye(t)]
            })
        }
      ...
      function Ye(e) {
        return { uri: l.Uri.parse(e.uri), range: b(e.range) }
      }
      var St = class {
          constructor(e) {
            this._worker = e
          ...
          provideReferences(e, n, i, r) {
            const t = e.uri
            return this._worker(t)
              .then((a) => a.findReferences(t.toString(), L(n)))
              .then((a) => {
                if (a) return a.map(Ye)
              })
          }
        },
        yt = class {
          ...
          provideRenameEdits(e, n, i, r) {
            const t = e.uri
            return this._worker(t)
              .then((a) => a.doRename(t.toString(), L(n), i))
              .then((a) => It(a))
          }
        }
      function It(e) {
        ...
        for (let i in e.changes) {
          ...
          for (let t of e.changes[i])
            n.push({ resource: r, versionId: void 0, textEdit: { range: b(t.range), text: t.newText } })
        }
        return { edits: n }
      }
      var $e = class {
            ...
            .then((r) => {
              if (r)
                return r.map((t) => ({
                  ...
                  kind: Tt(t.kind),
                  range: b(t.location.range),
                  selectionRange: b(t.location.range),
                  tags: [],
                }))
            })
        }
      ...
      var Dt = class {
          ...
          provideLinks(e, n) {
            ...
            return this._worker(i)
              ...
              .then((r) => {
                if (r) return { links: r.map((t) => ({ range: b(t.range), url: t.target })) }
              })
          }
        },
        Ge = class {
          ...
          provideDocumentFormattingEdits(e, n, i) {
            ...
            return this._worker(r).then((t) =>
              t.format(r.toString(), null, Ze(n)).then((a) => {
                if (!(!a || a.length === 0)) return a.map(x)
              }),
            )
          }
        },
        Qe = class {
          ...
          provideDocumentRangeFormattingEdits(e, n, i, r) {
            ...
            return this._worker(t).then((a) =>
              a.format(t.toString(), ce(n), Ze(i)).then((s) => {
                if (!(!s || s.length === 0)) return s.map(x)
              }),
            )
          }
        }
      ...
      var Ke = class {
          ...
          provideDocumentColors(e, n) {
            ...
            return this._worker(i)
              ...
              .then((r) => {
                if (r) return r.map((t) => ({ color: t.color, range: b(t.range) }))
              })
          }
          provideColorPresentations(e, n, i) {
            const r = e.uri
            return this._worker(r)
              .then((t) => t.getColorPresentations(r.toString(), n.color, ce(n.range)))
              .then((t) => {
                if (t)
                  return t.map((a) => {
                    let s = { label: a.label }
                    return (
                      a.textEdit && (s.textEdit = x(a.textEdit)),
                      a.additionalTextEdits && (s.additionalTextEdits = a.additionalTextEdits.map(x)),
                      s
                    )
                  })
              })
          ...
          provideFoldingRanges(e, n, i) {
            ...
            return this._worker(r)
              ...
              .then((t) => {
                if (t)
                  return t.map((a) => {
                    const s = { start: a.startLine + 1, end: a.endLine + 1 }
                    return typeof a.kind != 'undefined' && (s.kind = Pt(a.kind)), s
                  })
              })
          }
        }
      ...
      var tt = class {
        ...
        provideSelectionRanges(e, n, i) {
          const r = e.uri
          return this._worker(r)
            .then((t) => t.getSelectionRanges(r.toString(), n.map(L)))
            .then((t) => {
              if (t)
                return t.map((a) => {
                  const s = []
                  for (; a; ) s.push({ range: b(a.range) }), (a = a.parent)
                  return s
                })
            })
        }
      ...
      function Rt(e, n) {
        ...
        function D() {
          ...
          if (r < e.length && e.charCodeAt(r) === 46)
            if ((r++, r < e.length && F(e.charCodeAt(r)))) for (r++; r < e.length && F(e.charCodeAt(r)); ) r++
            else return (g = 3), e.substring(f, r)
          var E = r
...
`
                ...
                case 117:
                  var w = C(4, !0)
                  w >= 0 ? (f += String.fromCharCode(w)) : (g = 4)
                  break
                default:
                  g = 5
              }
        ...
        function $() {
          if (((t = ''), (g = 0), (a = r), (c = u), (v = d), r >= i)) return (a = i), (s = 17)
          var f = e.charCodeAt(r)
          if (de(f)) {
            do r++, (t += String.fromCharCode(f)), (f = e.charCodeAt(r))
            while (de(f))
            return (s = 15)
          }
          if (Y(f))
...
`)),
          ...
          switch (f) {
            ...
            case 57:
              return (t += D()), (s = 11)
            default:
              for (; r < i && Jt(f); ) r++, (f = e.charCodeAt(r))
              if (a !== r) {
      ...
      var Mt = Rt
      function Lt(e) {
        return { getInitialState: () => new re(null, null, !1, null), tokenize: (n, i) => zt(e, n, i) }
      }
      var nt = 'delimiter.bracket.json',
        it = 'delimiter.array.json',
        Nt = 'delimiter.colon.json',
        Ot = 'delimiter.comma.json',
        jt = 'keyword.json',
        xt = 'keyword.json',
        Ft = 'string.value.json',
        Wt = 'number.json',
        Ut = 'string.key.json',
        Vt = 'comment.block.json',
        ...
        re = class {
          ...
          clone() {
            return new re(this._state, this.scanError, this.lastWasColon, this.parents)
          }
          equals(e) {
            return e === this
              ? !0
              : !e || !(e instanceof re)
                ...
                : this.scanError === e.scanError &&
                  ...
                  W.equals(this.parents, e.parents)
          }
          getStateData() {
            return this._state
          }
      ...
      function zt(e, n, i, r = 0) {
        ...
        let u = i.lastWasColon,
          c = i.parents
        const d = { tokens: [], endState: i.clone() }
        for (;;) {
          let v = r + s.getPosition(),
            g = ''
          const C = s.scan()
          if (C === 17) break
          if (v === r + s.getPosition())
            throw new Error('Scanner did not advance, next 3 characters are: ' + n.substr(s.getPosition(), 3))
          switch ((a && (v -= t), (a = t > 0), C)) {
            case 1:
              ;(c = W.push(c, 0)), (g = nt), (u = !1)
              break
            case 2:
              ;(c = W.pop(c)), (g = nt), (u = !1)
              break
            case 3:
              ;(c = W.push(c, 1)), (g = it), (u = !1)
              break
            case 4:
              ;(c = W.pop(c)), (g = it), (u = !1)
              break
          ...
          ;(d.endState = new re(i.getStateData(), s.getTokenError(), u, c)), d.tokens.push({ startIndex: v, scopes: g })
        }
        return d
      }
      var Bt = class extends Be {
        constructor(e, n, i) {
          super(e, n, i.onDidChange),
            this._disposables.push(
              l.editor.onWillDisposeModel((r) => {
                this._resetSchema(r.uri)
              }),
            ),
            this._disposables.push(
              l.editor.onDidChangeModelLanguage((r) => {
      ...
      function Xt(e) {
        ...
        function a() {
          ...
          st(i),
            c.documentFormattingEdits && i.push(l.languages.registerDocumentFormattingEditProvider(u, new Ge(t))),
            c.documentRangeFormattingEdits &&
              i.push(l.languages.registerDocumentRangeFormattingEditProvider(u, new Qe(t))),
            c.completionItems && i.push(l.languages.registerCompletionItemProvider(u, new Xe(t, [' ', ':', '"']))),
            c.hovers && i.push(l.languages.registerHoverProvider(u, new qe(t))),
            c.documentSymbols && i.push(l.languages.registerDocumentSymbolProvider(u, new $e(t))),
            c.tokens && i.push(l.languages.setTokensProvider(u, Lt(!0))),
            c.colors && i.push(l.languages.registerColorProvider(u, new Ke(t))),
            c.foldingRanges && i.push(l.languages.registerFoldingRangeProvider(u, new et(t))),
            c.diagnostics && i.push(new Bt(u, t, e)),
            c.selectionRanges && i.push(l.languages.registerSelectionRangeProvider(u, new tt(t)))
        }
        a(), n.push(l.languages.setLanguageConfiguration(e.languageId, qt))
