      ...
      ;(function (x, T) {
        ...
        var x = 1e3,
          ...
          E = {
            ...
            p: function (i) {
              return (
                { M: l, y: v, w: k, d: m, D: O, h: w, m: p, s: S, ms: A, Q: J }[i] ||
                String(i || '')
                  .toLowerCase()
                  .replace(/s$/, '')
              )
        ...
        var L = (function () {
            ...
            return (
              ...
              (e.$g = function (t, r, n) {
                return o.u(t) ? this[r] : this.set(n, t)
              }),
              (e.unix = function () {
              ...
              (e.startOf = function (t, r) {
                var n = this,
                  ...
                  f = function (_, $) {
                    return o.w(n.toDate()[_].apply(n.toDate('s'), (u ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice($)), n)
                  },
                  h = this.$W,
                  d = this.$M,
                  y = this.$D,
              ...
              (e.add = function (t, r) {
                ...
                if (s === m) return a(1)
                if (s === k) return a(7)
                var f = ((n = {}), (n[p] = T), (n[w] = F), (n[S] = x), n)[s] || 1,
              ...
              (e.diff = function (t, r, n) {
                var u,
                  s = o.p(r),
                  a = c(t),
                  f = (a.utcOffset() - this.utcOffset()) * T,
                  h = this - a,
                  d = o.m(this, a)
                return (
                  (d =
