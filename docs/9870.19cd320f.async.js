...
var bt = (P, k, b) => (k in P ? Et(P, k, { enumerable: !0, configurable: !0, writable: !0, value: b }) : (P[k] = b))
var C = (P, k, b) => (bt(P, typeof k != 'symbol' ? k + '' : k, b), b)
;(self.webpackChunk = self.webpackChunk || []).push([
  [9870],
  {
    89870: function (P, k, b) {
      b.r(k),
        b.d(k, {
      ...
      var Ze = Object.defineProperty,
        ...
        de = (e, n, i, r) => {
          if ((n && typeof n == 'object') || typeof n == 'function')
            for (let t of Ke(n))
              !et.call(e, t) && t !== i && Ze(e, t, { get: () => n[t], enumerable: !(r = qe(n, t)) || r.enumerable })
          return e
        },
        tt = (e, n, i) => (de(e, n, 'default'), i && de(i, n, 'default')),
        c = {}
      tt(c, Ye)
      var rt = 2 * 60 * 1e3,
        Q = class {
          ...
          _checkIfIdle() {
            ...
            Date.now() - this._lastUsedTime > rt && this._stopWorker()
          }
          _getClient() {
            return (
      ...
      ;(function (e) {
        function n(r, t, a, o) {
          if (s.uinteger(r) && s.uinteger(t) && s.uinteger(a) && s.uinteger(o))
            return { start: E.create(r, t), end: E.create(a, o) }
          if (E.is(r) && E.is(t)) return { start: r, end: t }
          throw new Error('Range#create called with invalid arguments[' + r + ', ' + t + ', ' + a + ', ' + o + ']')
        }
        e.create = n
        function i(r) {
          var t = r
          return s.objectLiteral(t) && E.is(t.start) && E.is(t.end)
        }
        e.is = i
      })(p || (p = {}))
      var G
      ...
      ;(function (e) {
        ...
        function i(r) {
          ...
          return (
            ...
            (p.is(t.targetSelectionRange) || s.undefined(t.targetSelectionRange)) &&
            (p.is(t.originSelectionRange) || s.undefined(t.originSelectionRange))
          )
        }
        e.is = i
      })(ge || (ge = {}))
      ...
      ;(function (e) {
        ...
        function i(r) {
          var t = r
          return p.is(t.range) && J.is(t.color)
        }
        e.is = i
      })(le || (le = {}))
      var he
      ;(function (e) {
        ...
        function i(r) {
          ...
          return (
            s.string(t.label) &&
            (s.undefined(t.textEdit) || x.is(t)) &&
            (s.undefined(t.additionalTextEdits) || s.typedArray(t.additionalTextEdits, x.is))
          )
        }
        e.is = i
      })(he || (he = {}))
      ...
      ;(function (e) {
        ...
        function i(r) {
          var t = r
          return s.defined(t) && G.is(t.location) && s.string(t.message)
        }
        e.is = i
      })(Y || (Y = {}))
      var R
        ...
        function i(r) {
          ...
          return (
            ...
            (s.undefined(a.codeDescription) ||
              s.string((t = a.codeDescription) === null || t === void 0 ? void 0 : t.href)) &&
            (s.string(a.source) || s.undefined(a.source)) &&
            (s.undefined(a.relatedInformation) || s.typedArray(a.relatedInformation, Y.is))
          )
        }
        e.is = i
      })(U || (U = {}))
      ...
      ;(function (e) {
        ...
        function i(r) {
          ...
          return (
            ...
            s.objectLiteral(t) &&
            s.string(t.label) &&
            (s.boolean(t.needsConfirmation) || t.needsConfirmation === void 0) &&
            (s.string(t.description) || t.description === void 0)
          )
        }
        e.is = i
      })(D || (D = {}))
      ...
      ;(function (e) {
        ...
        function t(a) {
          var o = a
          return x.is(o) && (D.is(o.annotationId) || m.is(o.annotationId))
        }
        e.is = t
      })(y || (y = {}))
      var V
      ;(function (e) {
        ...
        function i(r) {
          var t = r
          return s.defined(t) && X.is(t.textDocument) && Array.isArray(t.edits)
        }
        e.is = i
      })(V || (V = {}))
      var L
      ;(function (e) {
        ...
        function i(r) {
          ...
          return (
            ...
            s.string(t.uri) &&
            (t.options === void 0 ||
              ((t.options.overwrite === void 0 || s.boolean(t.options.overwrite)) &&
                (t.options.ignoreIfExists === void 0 || s.boolean(t.options.ignoreIfExists)))) &&
            (t.annotationId === void 0 || m.is(t.annotationId))
          )
        }
        e.is = i
      })(L || (L = {}))
      ...
      ;(function (e) {
        ...
        function i(r) {
          ...
          return (
            ...
            s.string(t.uri) &&
            (t.options === void 0 ||
              ((t.options.recursive === void 0 || s.boolean(t.options.recursive)) &&
                (t.options.ignoreIfNotExists === void 0 || s.boolean(t.options.ignoreIfNotExists)))) &&
            (t.annotationId === void 0 || m.is(t.annotationId))
          )
        }
        e.is = i
          ...
          return (
            ...
            (r.documentChanges === void 0 ||
              r.documentChanges.every(function (t) {
                return s.string(t.kind) ? L.is(t) || j.is(t) || N.is(t) : V.is(t)
              }))
          )
        }
        e.is = n
          ...
          return (
              ...
              if (X.is(n)) {
                ...
                if (!r) {
                  ...
                  this._workspaceEdit.documentChanges.push(a),
                    (r = new z(t, this._changeAnnotations)),
                ...
                if (!r) {
                  var t = []
                  ;(this._workspaceEdit.changes[n] = t), (r = new z(t)), (this._textEditChanges[n] = r)
                }
                return r
              }
            }),
            (e.prototype.initDocumentChanges = function () {
              this._workspaceEdit.documentChanges === void 0 &&
                ...
                ((this._changeAnnotations = new _e()),
            ...
            (e.prototype.createFile = function (n, i, r) {
              if ((this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0))
                throw new Error('Workspace edit is not configured for document changes.')
              var t
              D.is(i) || m.is(i) ? (t = i) : (r = i)
              var a, o
              if (
                (t === void 0
                  ? (a = L.create(n, r))
                  : ((o = m.is(t) ? t : this._changeAnnotations.manage(t)), (a = L.create(n, r, o))),
                this._workspaceEdit.documentChanges.push(a),
                o !== void 0)
              )
                return o
            ...
            (e.prototype.renameFile = function (n, i, r, t) {
              if ((this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0))
                throw new Error('Workspace edit is not configured for document changes.')
              var a
              D.is(r) || m.is(r) ? (a = r) : (t = r)
              var o, u
              if (
                (a === void 0
                  ? (o = j.create(n, i, t))
                  : ((u = m.is(a) ? a : this._changeAnnotations.manage(a)), (o = j.create(n, i, t, u))),
            ...
            (e.prototype.deleteFile = function (n, i, r) {
              ...
              if (
                (t === void 0
                  ? (a = N.create(n, r))
                  : ((o = m.is(t) ? t : this._changeAnnotations.manage(t)), (a = N.create(n, r, o))),
                this._workspaceEdit.documentChanges.push(a),
                o !== void 0)
              )
                return o
      ...
      ;(function (e) {
        function n(i) {
          ...
          return (
            !!r &&
            s.objectLiteral(r) &&
            (q.is(r.contents) || B.is(r.contents) || s.typedArray(r.contents, B.is)) &&
      ...
      ;(function (e) {
        function n(r, t, a, o, u, g) {
          var d = { name: r, detail: t, kind: a, range: o, selectionRange: u }
        ...
        function i(r) {
          ...
          return (
            ...
            (t.detail === void 0 || s.string(t.detail)) &&
            (t.deprecated === void 0 || s.boolean(t.deprecated)) &&
      ...
      ;(function (e) {
        function n(r, t, a) {
          var o = { title: r },
            u = !0
          return (
            typeof t == 'string' ? ((u = !1), (o.kind = t)) : F.is(t) ? (o.command = t) : (o.edit = t),
            u && a !== void 0 && (o.kind = a),
            o
          )
        }
        ...
        function i(r) {
          ...
          return (
            t &&
            s.string(t.title) &&
            (t.diagnostics === void 0 || s.typedArray(t.diagnostics, U.is)) &&
            (t.kind === void 0 || s.string(t.kind)) &&
            (t.edit !== void 0 || t.command !== void 0) &&
            (t.command === void 0 || F.is(t.command)) &&
            (t.isPreferred === void 0 || s.boolean(t.isPreferred)) &&
      ...
      ;(function (e) {
        ...
        function i(r) {
          var t = r
          return s.defined(t) && p.is(t.range) && (s.undefined(t.command) || F.is(t.command))
        }
        e.is = i
      })(Ne || (Ne = {}))
      var We
      ...
      ;(function (e) {
        ...
        function r(a, o) {
          for (
            var u = a.getText(),
              g = t(o, function (S, $) {
                var Je = S.range.start.line - $.range.start.line
                return Je === 0 ? S.range.start.character - $.range.start.character : Je
              }),
              d = u.length,
              v = g.length - 1;
            v >= 0;
            ...
            var w = g[v],
              A = a.offsetAt(w.range.start),
              f = a.offsetAt(w.range.end)
            if (f <= d) u = u.substring(0, A) + w.newText + u.substring(f, u.length)
        ...
        function t(a, o) {
          ...
          var u = (a.length / 2) | 0,
            ...
            d = a.slice(u)
          t(g, o), t(d, o)
          for (var v = 0, w = 0, A = 0; v < g.length && w < d.length; ) {
            var f = o(g[v], d[w])
            f <= 0 ? (a[A++] = g[v++]) : (a[A++] = d[w++])
          }
          for (; v < g.length; ) a[A++] = g[v++]
          for (; w < d.length; ) a[A++] = d[w++]
          return a
        }
      })(Ue || (Ue = {}))
      var nt = (function () {
...
` &&
      ...
      ;(function (e) {
        ...
        e.number = o
        function u(f, S, $) {
          return n.call(f) === '[object Number]' && S <= f && f <= $
        }
        e.numberRange = u
        function g(f) {
        ...
        e.objectLiteral = w
        function A(f, S) {
          return Array.isArray(f) && f.every(S)
        }
        e.typedArray = A
      })(s || (s = {}))
      var it = class {
        constructor(e, n, i) {
          C(this, '_disposables', [])
          C(this, '_listener', Object.create(null))
      ...
      var Ve = class {
        ...
        provideCompletionItems(e, n, i, r) {
          ...
          return this._worker(t)
            .then((a) => a.doComplete(t.toString(), I(n)))
            .then((a) => {
              if (!a) return
      ...
      var te = class {
        ...
        provideHover(e, n, i) {
          ...
          return this._worker(r)
            .then((t) => t.doHover(r.toString(), I(n)))
            .then((t) => {
              if (t) return { range: _(t.range), contents: ft(t.contents) }
            })
        }
      }
      function dt(e) {
...
` +
      ...
      function ft(e) {
        if (e) return Array.isArray(e) ? e.map(ze) : [ze(e)]
      }
      var re = class {
        constructor(e) {
          this._worker = e
        ...
        provideDocumentHighlights(e, n, i) {
          const r = e.uri
          return this._worker(r)
            .then((t) => t.findDocumentHighlights(r.toString(), I(n)))
            .then((t) => {
              if (t) return t.map((a) => ({ range: _(a.range), kind: gt(a.kind) }))
            })
        }
      }
      function gt(e) {
      ...
      var lt = class {
        ...
        provideDefinition(e, n, i) {
          const r = e.uri
          return this._worker(r)
            .then((t) => t.findDefinition(r.toString(), I(n)))
            .then((t) => {
              if (t) return [Xe(t)]
            })
        }
      ...
      var ht = class {
          ...
          provideReferences(e, n, i, r) {
            const t = e.uri
            return this._worker(t)
              .then((a) => a.findReferences(t.toString(), I(n)))
              .then((a) => {
                if (a) return a.map(Xe)
              })
          }
        },
        ne = class {
          ...
          provideRenameEdits(e, n, i, r) {
            const t = e.uri
            return this._worker(t)
              .then((a) => a.doRename(t.toString(), I(n), i))
              .then((a) => vt(a))
          }
        }
      function vt(e) {
        ...
        for (let i in e.changes) {
          ...
          for (let t of e.changes[i])
            n.push({ resource: r, versionId: void 0, textEdit: { range: _(t.range), text: t.newText } })
        }
        return { edits: n }
      }
      var ie = class {
      ...
      var ae = class {
          ...
          provideLinks(e, n) {
            ...
            return this._worker(i)
              ...
              .then((r) => {
                if (r) return { links: r.map((t) => ({ range: _(t.range), url: t.target })) }
              })
          }
        },
        oe = class {
          ...
          provideDocumentFormattingEdits(e, n, i) {
            ...
            return this._worker(r).then((t) =>
              t.format(r.toString(), null, Be(n)).then((a) => {
        ...
        se = class {
          ...
          provideDocumentRangeFormattingEdits(e, n, i, r) {
            ...
            return this._worker(t).then((a) =>
              a.format(t.toString(), ee(n), Be(i)).then((o) => {
      ...
      var mt = class {
          ...
          provideDocumentColors(e, n) {
            ...
            return this._worker(i)
              ...
              .then((r) => {
                if (r) return r.map((t) => ({ color: t.color, range: _(t.range) }))
              })
          }
          provideColorPresentations(e, n, i) {
            const r = e.uri
            return this._worker(r)
              .then((t) => t.getColorPresentations(r.toString(), n.color, ee(n.range)))
              .then((t) => {
                if (t)
                  return t.map((a) => {
                    let o = { label: a.label }
              ...
              .then((t) => {
                if (t)
                  return t.map((a) => {
                    ...
                    return typeof a.kind != 'undefined' && (o.kind = _t(a.kind)), o
                  })
              })
          }
        }
      ...
      var ce = class {
          ...
          provideSelectionRanges(e, n, i) {
            const r = e.uri
            return this._worker(r)
              .then((t) => t.getSelectionRanges(r.toString(), n.map(I)))
              .then((t) => {
                if (t)
                  return t.map((a) => {
                    const o = []
      ...
      function wt(e) {
        ...
        let r = e.languageId
        c.languages.registerCompletionItemProvider(r, new $e(i)),
          c.languages.registerHoverProvider(r, new te(i)),
          c.languages.registerDocumentHighlightProvider(r, new re(i)),
          c.languages.registerLinkProvider(r, new ae(i)),
          c.languages.registerFoldingRangeProvider(r, new ue(i)),
          c.languages.registerDocumentSymbolProvider(r, new ie(i)),
          c.languages.registerSelectionRangeProvider(r, new ce(i)),
          c.languages.registerRenameProvider(r, new ne(i)),
          r === 'html' &&
            (c.languages.registerDocumentFormattingEditProvider(r, new oe(i)),
            c.languages.registerDocumentRangeFormattingEditProvider(r, new se(i)))
      }
      function kt(e) {
        const n = [],
          i = [],
        ...
        function a() {
          ...
          Ge(i),
            u.completionItems && i.push(c.languages.registerCompletionItemProvider(o, new $e(t))),
            u.hovers && i.push(c.languages.registerHoverProvider(o, new te(t))),
            u.documentHighlights && i.push(c.languages.registerDocumentHighlightProvider(o, new re(t))),
            u.links && i.push(c.languages.registerLinkProvider(o, new ae(t))),
            u.documentSymbols && i.push(c.languages.registerDocumentSymbolProvider(o, new ie(t))),
            u.rename && i.push(c.languages.registerRenameProvider(o, new ne(t))),
            u.foldingRanges && i.push(c.languages.registerFoldingRangeProvider(o, new ue(t))),
            u.selectionRanges && i.push(c.languages.registerSelectionRangeProvider(o, new ce(t))),
            u.documentFormattingEdits && i.push(c.languages.registerDocumentFormattingEditProvider(o, new oe(t))),
            u.documentRangeFormattingEdits &&
              i.push(c.languages.registerDocumentRangeFormattingEditProvider(o, new se(t)))
        }
        return a(), n.push(Qe(i)), Qe(n)
      }
      function Qe(e) {
        return { dispose: () => Ge(e) }
      }
