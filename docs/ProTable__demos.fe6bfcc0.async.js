    ...
    52526: function (tu, g, u) {
      ...
      var H = function () {
          var n,
            ...
            C = r[0],
            m = r[1],
            v = (0, K.Z)('preview-demo-code', { defaultValue: l }),
            i = E()(v, 2),
            f = i[0],
            y = i[1],
            q = (0, N.Z)(y, { wait: 1e3 }),
            A = (0, U.Z)(f, { wait: 120 }),
            _ = (0, t.useState)(function () {
              try {
                var e = new Function(f)()
                return e
              } catch (nu) {
                console.warn('\u4EE3\u7801\u6709\u95EE\u9898', nu)
                var d = new Function(l)()
                return d
              }
            }),
            p = E()(_, 2),
          ...
          return (
            (0, G.Z)(
              function () {
                try {
                  ...
                  if (!(0, z.Z)(e)) {
                    console.log(e), console.warn('\u8FD4\u56DE\u5185\u5BB9\u5E76\u975E\u5BF9\u8C61\uFF0C\u5FFD\u7565')
                    return
                  }
                  uu(e), s.ZP.info('\u914D\u7F6E\u5DF2\u66F4\u65B0')
                } catch (d) {
                  console.warn(d),
                    console.warn('\u8BED\u6CD5\u89E3\u6790\u9519\u8BEF\uFF0C\u5FFD\u7565'),
                    s.ZP.warning(
                      '\u8BED\u6CD5\u89E3\u6790\u9519\u8BEF\uFF0C\u8BF7\u7ED3\u5408 F12 \u5DE5\u5177\u6392\u67E5\u9519\u8BEF\u6216\u91CD\u7F6E\u4EE3\u7801',
                    )
                }
              },
              [A],
            ...
            t.createElement(
              ...
              t.createElement(
                ...
                T()({ localeKey: 'zh_CN' }, c, {
                  iconActions: [].concat(
                    F()((n = c == null ? void 0 : c.iconActions) !== null && n !== void 0 ? n : []),
                    [
                      {
                        builtIn: 'settings',
                        onClick: function () {
                          ;(0, L.Z)({
                            content: t.createElement(W, {
                              width: '100%',
                              height: '100%',
                              language: 'javascript',
                              value: f,
        ...
        J = k()
      Object.assign(window, { message: s.ZP, dayjs: o(), globalTools: I, mockData: J, getMockDataType: B })
      var X = `const { mockData, message, dayjs, getMockDataType } = window
                          ...
                          (0, M.Z)(function () {
                            var C = B(r),
                              m = {
                                ...
                                select: (0, b.Z)([1, 2]),
                                multipleSelect: F()(new Set([1, 2])),
                                text: (0, a.Z)(0, 999999999999999),
                              }
                            if (!((0, a.Z)(0, 10) > 8)) return C in m ? m[C] : (0, a.Z)(0, 999999999999999)
                          }),
                        )
                      }),
                  ),
