...
var kt = (R, k, b) => (k in R ? wt(R, k, { enumerable: !0, configurable: !0, writable: !0, value: b }) : (R[k] = b))
var A = (R, k, b) => (kt(R, typeof k != 'symbol' ? k + '' : k, b), b)
;(self.webpackChunk = self.webpackChunk || []).push([
  [9128],
  {
    29128: function (R, k, b) {
      b.r(k),
        b.d(k, {
      ...
      var Ke = Object.defineProperty,
        ...
        ee = (t, n, i, r) => {
          if ((n && typeof n == 'object') || typeof n == 'function')
            for (let e of tt(n))
              !rt.call(t, e) && e !== i && Ke(t, e, { get: () => n[e], enumerable: !(r = et(n, e)) || r.enumerable })
          return t
        },
        nt = (t, n, i) => (ee(t, n, 'default'), i && ee(i, n, 'default')),
        c = {}
      nt(c, qe)
      var it = 2 * 60 * 1e3,
        te = class {
      ...
      ;(function (t) {
        function n(r, e) {
          return (
            r === Number.MAX_VALUE && (r = U.MAX_VALUE),
            e === Number.MAX_VALUE && (e = U.MAX_VALUE),
            { line: r, character: e }
          )
        }
        t.create = n
      ...
      ;(function (t) {
        function n(r, e, a, o) {
          if (s.uinteger(r) && s.uinteger(e) && s.uinteger(a) && s.uinteger(o))
            return { start: E.create(r, e), end: E.create(a, o) }
          if (E.is(r) && E.is(e)) return { start: r, end: e }
          throw new Error('Range#create called with invalid arguments[' + r + ', ' + e + ', ' + a + ', ' + o + ']')
        }
        t.create = n
        function i(r) {
          var e = r
          return s.objectLiteral(e) && E.is(e.start) && E.is(e.end)
        }
        t.is = i
      })(p || (p = {}))
      var Q
      ...
      ;(function (t) {
        ...
        function i(r) {
          ...
          return (
            ...
            (p.is(e.targetSelectionRange) || s.undefined(e.targetSelectionRange)) &&
            (p.is(e.originSelectionRange) || s.undefined(e.originSelectionRange))
          )
        }
        t.is = i
      })(ne || (ne = {}))
      ...
      ;(function (t) {
        function n(r, e, a, o) {
          return { red: r, green: e, blue: a, alpha: o }
        }
        t.create = n
        function i(r) {
          var e = r
      ...
      ;(function (t) {
        function n(r, e, a) {
          return { label: r, textEdit: e, additionalTextEdits: a }
        }
        t.create = n
        function i(r) {
          var e = r
          return (
            s.string(e.label) &&
            (s.undefined(e.textEdit) || x.is(e)) &&
            (s.undefined(e.additionalTextEdits) || s.typedArray(e.additionalTextEdits, x.is))
          )
        }
        t.is = i
      })(ae || (ae = {}))
      ...
      ;(function (t) {
        ...
        function i(r) {
          var e = r
          return s.defined(e) && Q.is(e.location) && s.string(e.message)
        }
        t.is = i
      })(J || (J = {}))
      var D
        ...
        function i(r) {
          ...
          return (
            ...
            (s.undefined(a.codeDescription) ||
              s.string((e = a.codeDescription) === null || e === void 0 ? void 0 : e.href)) &&
            (s.string(a.source) || s.undefined(a.source)) &&
            (s.undefined(a.relatedInformation) || s.typedArray(a.relatedInformation, J.is))
          )
        }
        t.is = i
      })(H || (H = {}))
      ...
      ;(function (t) {
        ...
        function e(a) {
          var o = a
          return x.is(o) && (P.is(o.annotationId) || m.is(o.annotationId))
        }
        t.is = e
      })(y || (y = {}))
      var V
      ;(function (t) {
        ...
        function i(r) {
          var e = r
          return s.defined(e) && X.is(e.textDocument) && Array.isArray(e.edits)
        }
        t.is = i
      })(V || (V = {}))
      var L
      ;(function (t) {
        function n(r, e, a) {
          ...
          return (
            e !== void 0 && (e.overwrite !== void 0 || e.ignoreIfExists !== void 0) && (o.options = e),
        ...
        function i(r) {
          ...
          return (
            ...
            s.string(e.uri) &&
            (e.options === void 0 ||
              ((e.options.overwrite === void 0 || s.boolean(e.options.overwrite)) &&
                (e.options.ignoreIfExists === void 0 || s.boolean(e.options.ignoreIfExists)))) &&
            (e.annotationId === void 0 || m.is(e.annotationId))
          )
        }
        t.is = i
      })(L || (L = {}))
      ...
      ;(function (t) {
        function n(r, e, a) {
          ...
          return (
            e !== void 0 && (e.recursive !== void 0 || e.ignoreIfNotExists !== void 0) && (o.options = e),
            a !== void 0 && (o.annotationId = a),
            o
          )
        }
        ...
        function i(r) {
          ...
          return (
            ...
            s.string(e.uri) &&
            (e.options === void 0 ||
              ((e.options.recursive === void 0 || s.boolean(e.options.recursive)) &&
                (e.options.ignoreIfNotExists === void 0 || s.boolean(e.options.ignoreIfNotExists)))) &&
            (e.annotationId === void 0 || m.is(e.annotationId))
          )
        }
        t.is = i
          ...
          return (
            ...
            (r.documentChanges === void 0 ||
              r.documentChanges.every(function (e) {
                return s.string(e.kind) ? L.is(e) || j.is(e) || N.is(e) : V.is(e)
              }))
          )
        }
        t.is = n
      ...
      var z = (function () {
          ...
          return (
            (t.prototype.insert = function (n, i, r) {
              var e, a
              if (
                (r === void 0
                  ? (e = x.insert(n, i))
                  : m.is(r)
                    ? ((a = r), (e = y.insert(n, i, r)))
            ...
            ;(this._textEditChanges = Object.create(null)),
              n !== void 0
                ? ((this._workspaceEdit = n),
                  n.documentChanges
                    ? ((this._changeAnnotations = new ce(n.changeAnnotations)),
          ...
          return (
            ...
            (t.prototype.getTextEditChange = function (n) {
              if (X.is(n)) {
                ...
                if (!r) {
                  var e = []
                  ;(this._workspaceEdit.changes[n] = e), (r = new z(e)), (this._textEditChanges[n] = r)
                }
                return r
              }
            }),
            ...
            (t.prototype.createFile = function (n, i, r) {
              if ((this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0))
                throw new Error('Workspace edit is not configured for document changes.')
              var e
              P.is(i) || m.is(i) ? (e = i) : (r = i)
              var a, o
              if (
                (e === void 0
                  ? (a = L.create(n, r))
                  : ((o = m.is(e) ? e : this._changeAnnotations.manage(e)), (a = L.create(n, r, o))),
                this._workspaceEdit.documentChanges.push(a),
                o !== void 0)
              )
                return o
            ...
            (t.prototype.renameFile = function (n, i, r, e) {
              if ((this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0))
                throw new Error('Workspace edit is not configured for document changes.')
              var a
              P.is(r) || m.is(r) ? (a = r) : (e = r)
              var o, u
              if (
                (a === void 0
                  ? (o = j.create(n, i, e))
                  : ((u = m.is(a) ? a : this._changeAnnotations.manage(a)), (o = j.create(n, i, e, u))),
            ...
            (t.prototype.deleteFile = function (n, i, r) {
              ...
              if (
                (e === void 0
                  ? (a = N.create(n, r))
                  : ((o = m.is(e) ? e : this._changeAnnotations.manage(e)), (a = N.create(n, r, o))),
                this._workspaceEdit.documentChanges.push(a),
                o !== void 0)
              )
                return o
      ...
      ;(function (t) {
        function n(i) {
          ...
          return (
            !!r &&
            s.objectLiteral(r) &&
            (Z.is(r.contents) || B.is(r.contents) || s.typedArray(r.contents, B.is)) &&
            (i.range === void 0 || p.is(i.range))
          )
        }
        t.is = n
      })(_e || (_e = {}))
      ...
      ;(function (t) {
        function n(i, r, e, a, o) {
          var u = { name: i, kind: r, location: { uri: a, range: e } }
      ...
      ;(function (t) {
        function n(r, e, a, o, u, g) {
          var d = { name: r, detail: e, kind: a, range: o, selectionRange: u }
      ...
      ;(function (t) {
        ...
        function i(r) {
          var e = r
          return (
            s.defined(e) && s.typedArray(e.diagnostics, H.is) && (e.only === void 0 || s.typedArray(e.only, s.string))
          )
        }
        t.is = i
      })(ye || (ye = {}))
      ...
      ;(function (t) {
        function n(r, e, a) {
          var o = { title: r },
            u = !0
          return (
            typeof e == 'string' ? ((u = !1), (o.kind = e)) : F.is(e) ? (o.command = e) : (o.edit = e),
            u && a !== void 0 && (o.kind = a),
            o
          )
        }
        ...
        function i(r) {
          ...
          return (
            e &&
            s.string(e.title) &&
            (e.diagnostics === void 0 || s.typedArray(e.diagnostics, H.is)) &&
            (e.kind === void 0 || s.string(e.kind)) &&
            (e.edit !== void 0 || e.command !== void 0) &&
            (e.command === void 0 || F.is(e.command)) &&
            (e.isPreferred === void 0 || s.boolean(e.isPreferred)) &&
            (e.edit === void 0 || Y.is(e.edit))
          )
        }
        t.is = i
      })(Ie || (Ie = {}))
      ...
      ;(function (t) {
        ...
        function i(r) {
          var e = r
          return s.defined(e) && p.is(e.range) && (s.undefined(e.command) || F.is(e.command))
        }
        t.is = i
      })(Re || (Re = {}))
      var De
      ...
      ;(function (t) {
        ...
        function r(a, o) {
          for (
            var u = a.getText(),
              g = e(o, function (T, $) {
                var Ze = T.range.start.line - $.range.start.line
                return Ze === 0 ? T.range.start.character - $.range.start.character : Ze
              }),
              d = u.length,
              v = g.length - 1;
            v >= 0;
            ...
            var w = g[v],
              C = a.offsetAt(w.range.start),
              f = a.offsetAt(w.range.end)
            if (f <= d) u = u.substring(0, C) + w.newText + u.substring(f, u.length)
        ...
        function e(a, o) {
          ...
          var u = (a.length / 2) | 0,
            ...
            d = a.slice(u)
          e(g, o), e(d, o)
          for (var v = 0, w = 0, C = 0; v < g.length && w < d.length; ) {
            var f = o(g[v], d[w])
            f <= 0 ? (a[C++] = g[v++]) : (a[C++] = d[w++])
          }
          for (; v < g.length; ) a[C++] = g[v++]
          for (; w < d.length; ) a[C++] = d[w++]
          return a
        }
      })(Te || (Te = {}))
      var at = (function () {
...
` &&
            ...
            (t.prototype.positionAt = function (n) {
              ...
              var i = this.getLineOffsets(),
                r = 0,
                e = i.length
              if (e === 0) return E.create(0, n)
              for (; r < e; ) {
                var a = Math.floor((r + e) / 2)
                i[a] > n ? (e = a) : (r = a + 1)
              }
              var o = r - 1
              return E.create(o, n - i[o])
            }),
            (t.prototype.offsetAt = function (n) {
              ...
              var r = i[n.line],
                e = n.line + 1 < i.length ? i[n.line + 1] : this._content.length
      ...
      ;(function (t) {
        ...
        t.number = o
        function u(f, T, $) {
          return n.call(f) === '[object Number]' && T <= f && f <= $
        }
        t.numberRange = u
        function g(f) {
        ...
        t.objectLiteral = w
        function C(f, T) {
          return Array.isArray(f) && f.every(T)
        }
        t.typedArray = C
      })(s || (s = {}))
      var Se = class {
        constructor(t, n, i) {
          A(this, '_disposables', [])
          A(this, '_listener', Object.create(null))
          ;(this._languageId = t), (this._worker = n)
          const r = (a) => {
              let o = a.getLanguageId()
              if (o !== this._languageId) return
              let u
          ...
          this._disposables.push(c.editor.onDidCreateModel(r)),
            this._disposables.push(c.editor.onWillDisposeModel(e)),
        ...
        _doValidate(t, n) {
          this._worker(t)
            .then((i) => i.doValidation(t.toString()))
            .then((i) => {
              const r = i.map((a) => st(t, a))
      ...
      var Fe = class {
        ...
        provideCompletionItems(t, n, i, r) {
          ...
          return this._worker(e)
            .then((a) => a.doComplete(e.toString(), I(n)))
            .then((a) => {
              if (!a) return
              const o = t.getWordUntilPosition(n),
                u = new c.Range(n.lineNumber, o.startColumn, n.lineNumber, o.endColumn),
                g = a.items.map((d) => {
                  const v = {
                    label: d.label,
                  ...
                  return (
                    d.textEdit &&
                      (ut(d.textEdit)
                        ? (v.range = { insert: _(d.textEdit.insert), replace: _(d.textEdit.replace) })
                        : (v.range = _(d.textEdit.range)),
                      (v.insertText = d.textEdit.newText)),
                    d.additionalTextEdits && (v.additionalTextEdits = d.additionalTextEdits.map(M)),
                    d.insertTextFormat === q.Snippet &&
                      (v.insertTextRules = c.languages.CompletionItemInsertTextRule.InsertAsSnippet),
                    v
                  )
                })
      ...
      function _(t) {
        if (t) return new c.Range(t.start.line + 1, t.start.character + 1, t.end.line + 1, t.end.character + 1)
      }
      function ut(t) {
      ...
      function M(t) {
        if (t) return { range: _(t.range), text: t.newText }
      }
      function dt(t) {
      ...
      var Le = class {
        ...
        provideHover(t, n, i) {
          ...
          return this._worker(r)
            .then((e) => e.doHover(r.toString(), I(n)))
            .then((e) => {
              if (e) return { range: _(e.range), contents: gt(e.contents) }
            })
        }
      }
      function ft(t) {
...
` +
      ...
      function gt(t) {
        if (t) return Array.isArray(t) ? t.map(je) : [je(t)]
      }
      var Ne = class {
        constructor(t) {
          this._worker = t
        ...
        provideDocumentHighlights(t, n, i) {
          const r = t.uri
          return this._worker(r)
            .then((e) => e.findDocumentHighlights(r.toString(), I(n)))
            .then((e) => {
              if (e) return e.map((a) => ({ range: _(a.range), kind: lt(a.kind) }))
            })
        }
      }
      function lt(t) {
      ...
      var We = class {
        ...
        provideDefinition(t, n, i) {
          const r = t.uri
          return this._worker(r)
            .then((e) => e.findDefinition(r.toString(), I(n)))
            .then((e) => {
              if (e) return [Oe(e)]
            })
        }
      ...
      function Oe(t) {
        return { uri: c.Uri.parse(t.uri), range: _(t.range) }
      }
      var Ue = class {
          constructor(t) {
            this._worker = t
          ...
          provideReferences(t, n, i, r) {
            const e = t.uri
            return this._worker(e)
              .then((a) => a.findReferences(e.toString(), I(n)))
              .then((a) => {
                if (a) return a.map(Oe)
              })
          }
        },
        He = class {
          ...
          provideRenameEdits(t, n, i, r) {
            const e = t.uri
            return this._worker(e)
              .then((a) => a.doRename(e.toString(), I(n), i))
              .then((a) => ht(a))
          }
        }
      function ht(t) {
        ...
        for (let i in t.changes) {
          ...
          for (let e of t.changes[i])
            n.push({ resource: r, versionId: void 0, textEdit: { range: _(e.range), text: e.newText } })
        }
        return { edits: n }
      }
      var Ve = class {
      ...
      var pt = class {
          ...
          provideLinks(t, n) {
            ...
            return this._worker(i)
              ...
              .then((r) => {
                if (r) return { links: r.map((e) => ({ range: _(e.range), url: e.target })) }
              })
          }
        },
        ze = class {
          ...
          provideDocumentFormattingEdits(t, n, i) {
            ...
            return this._worker(r).then((e) =>
              e.format(r.toString(), null, Be(n)).then((a) => {
                if (!(!a || a.length === 0)) return a.map(M)
              }),
            )
          }
        },
        Xe = class {
          ...
          provideDocumentRangeFormattingEdits(t, n, i, r) {
            const e = t.uri
            return this._worker(e).then((a) =>
              a.format(e.toString(), K(n), Be(i)).then((o) => {
      ...
      var $e = class {
          ...
          provideDocumentColors(t, n) {
            ...
            return this._worker(i)
              ...
              .then((r) => {
                if (r) return r.map((e) => ({ color: e.color, range: _(e.range) }))
              })
          }
          provideColorPresentations(t, n, i) {
            const r = t.uri
            return this._worker(r)
              .then((e) => e.getColorPresentations(r.toString(), n.color, K(n.range)))
              .then((e) => {
                if (e)
                  return e.map((a) => {
                    let o = { label: a.label }
                    return (
                      a.textEdit && (o.textEdit = M(a.textEdit)),
                      a.additionalTextEdits && (o.additionalTextEdits = a.additionalTextEdits.map(M)),
                      o
                    )
                  })
              })
        ...
        Qe = class {
          ...
          provideFoldingRanges(t, n, i) {
            const r = t.uri
            return this._worker(r)
              .then((e) => e.getFoldingRanges(r.toString(), n))
              .then((e) => {
                if (e)
                  return e.map((a) => {
                    const o = { start: a.startLine + 1, end: a.endLine + 1 }
                    return typeof a.kind != 'undefined' && (o.kind = mt(a.kind)), o
                  })
              })
          }
        }
      ...
      var Ge = class {
        ...
        provideSelectionRanges(t, n, i) {
          const r = t.uri
          return this._worker(r)
            .then((e) => e.getSelectionRanges(r.toString(), n.map(I)))
            .then((e) => {
              if (e)
                return e.map((a) => {
                  const o = []
      ...
      function _t(t) {
        ...
        function a() {
          ...
          Ye(i),
            u.completionItems && i.push(c.languages.registerCompletionItemProvider(o, new Fe(e, ['/', '-', ':']))),
            u.hovers && i.push(c.languages.registerHoverProvider(o, new Le(e))),
            u.documentHighlights && i.push(c.languages.registerDocumentHighlightProvider(o, new Ne(e))),
            u.definitions && i.push(c.languages.registerDefinitionProvider(o, new We(e))),
            u.references && i.push(c.languages.registerReferenceProvider(o, new Ue(e))),
            u.documentSymbols && i.push(c.languages.registerDocumentSymbolProvider(o, new Ve(e))),
            u.rename && i.push(c.languages.registerRenameProvider(o, new He(e))),
            u.colors && i.push(c.languages.registerColorProvider(o, new $e(e))),
            u.foldingRanges && i.push(c.languages.registerFoldingRangeProvider(o, new Qe(e))),
            u.diagnostics && i.push(new Se(o, e, t.onDidChange)),
            u.selectionRanges && i.push(c.languages.registerSelectionRangeProvider(o, new Ge(e))),
            u.documentFormattingEdits && i.push(c.languages.registerDocumentFormattingEditProvider(o, new ze(e))),
            u.documentRangeFormattingEdits &&
              i.push(c.languages.registerDocumentRangeFormattingEditProvider(o, new Xe(e)))
        }
        return a(), n.push(Je(i)), Je(n)
      }
      function Je(t) {
        return { dispose: () => Ye(t) }
      }
